...
METADATA = {
    ...
    'author':           """Scav,Threads""",
    #'author_email':     '',
    'url':              """http://pyweek.org/e/AllAboutMonstrs/""",
    'classifiers':      [
...
PACKAGEDATA = {
    ...
    'package_dir': {'AllAboutMonstrs': 'AllAboutMonstrs',
                   },
    'packages': ['AllAboutMonstrs',
                ],
    'scripts': ['scripts/AllAboutMonstrs'],
}
...
_DATA_DIR = os.path.join('AllAboutMonstrs', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'AllAboutMonstrs': data_dirs}
...
src = []
add_files(src,os.walk('AllAboutMonstrs'))
